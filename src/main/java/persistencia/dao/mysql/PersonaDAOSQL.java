...
public class PersonaDAOSQL implements PersonaDAO
{
	...
	private static final String readallLoc= " SELECT idPersona, ap.Nombre, Telefono, calle, altura, piso, f_cumpleaños, email, depto, atip.nombre, al.nombre , apr.nombre , aps.nombre, lugarTur, dominioMail FROM agenda.personas ap\r\n"
			+ "	 left join   agenda.tipocontacto atip\r\n"
			+ "	 on  ap.idTipoContacto = atip.id\r\n"
			+ "	 left join agenda.localidad al\r\n"
			+ "	 on ap.idLocalidad = al.id \r\n"
